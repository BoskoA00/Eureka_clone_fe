...
const HomeComponent = () => {
  ...
  const passwordReset = async () => {
    if (
      loginEmail.trim() !== "" &&
      loginEmail.trim() !== null &&
      loginEmail.trim() !== undefined
    ) {
      try {
        let r = await axios.post(
          process.env.REACT_APP_API_URL + "api/User/sendPasswordReset",
          {
  ...
  const renderDays = () => {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      days.push(
        <div className="day-hc-schedule" key={i}>
          <div className="hc-2-1-1">{getLabel(dayOffset + 1)}</div>
          <div className="hc-day-title">{dayName} </div>
          <div className="hc-day-date">
            {month} {dayNumber}
          </div>
          <div className="hc-day-time">
            {times.map((time, index) => (
              <button
                className="hc-time-button"
                key={index}
  ...
  const handleNextDays = () => {
    ...
    setNextDays(nextDays + 1);
  };
  const hadnlePreviousDays = () => {
    setDayOffset(dayOffset - 2);
    setNextDays(nextDays - 1);
  };
  ...
  return (
    <div className="hc-main-main">
      {!registerForm && !logForm && !appointments && !codes && (
        <>
          <div className="hc-main-buttons">
            {!user && (
              <>
                <div className="hc-main-buttons-button">
                  <button className="hc-main-button" onClick={signUpForm}>
                    SIGN UP
                  </button>
                </div>
                <div className="hc-main-buttons-button">
                  <button className="hc-main-button" onClick={loginForm}>
                    LOGIN
                  </button>
                </div>
              </>
              ...
              <div className="email-button">
                ...
                {userMenu && (
                  <div className="dropdown-menu">
                    <button onClick={handleAppointmentsClick}>
                      Appointments
                    </button>
          ...
          <div className="hc-main-text-1">
            <p>
              PLEASE MAKE SURE YOU SELECT THE CORRECT TIME ZONE,
              <br /> SO YOU DON'T MISS YOUR APPOINTMENT.
            </p>
          </div>
          <div className="hc-main-d-t">
            {state !== 0 ? (
              <div>
          ...
          <div className="hc-main-text-2">
            <h3>APPOINTMENT</h3>
          </div>
          <div className="hc-main-text-3">
            <div className="hc-main-text-3-1">
              <p className="hc-main-t-3-1-p1">
                Eureka Free Zoom Consultation with Michelle Hardie
              </p>
              <p className="hc-main-t-3-1-p2">
                30 minutes @ £0.99{state == 1 ? "," + time + "," + date : ""}
              </p>
            </div>
            <div className="hc-main-text-3-2">
              {!showMore && (
                <p>
                  Use code NOTAROBOT for FREE consultation!
                  <br />
                  <br /> The consultation is completely free, however
                  unfortunately we have had many requests from bots in the last
                  few months. In order to reduce bots taking up bookings, we
                  have added a 0.99GBP fee t ...
                </p>
              )}
              {showMore && (
                <p>
                  ...
                  <br />
                  <br />
                  The consultation is completely free, however unfortunately we
                  have had many requests from bots in the last few months. In
                  order to reduce bots taking up bookings, we have added a
                  0.99GBP fee to the booking form, which is waivered by
                  redeeming the code "NOTAROBOT" at the end. The consultation
                  booking can then be completed at no cost. Please accept our
                  apologies for any inconvenience this may cause.
                </p>
              )}
            </div>
            <div className="hc-main-t-3-2-button">
              <button
                className="hc-main-button"
          ...
          {state == 0 && (
            <>
              <div className="hc-main-appointemnt-times">
                <div className="hc-main-at-title">
                  <span>TIME ZONE:</span>
                  <button
                    className="hc-main-button-2"
              ...
              <div className="hc-schedule-container">
                <div className="next-days-button">
                  {nextDays === 0 ? (
                    ""
                  ) : (
                    <button
                      className="next-days-button"
                      onClick={hadnlePreviousDays}
                    >
                      <ArrowBackIos />
                    </button>
                  )}
          ...
          {state == 1 && (
            <>
              <div className="hc-main-appointment-form">
                <div className="hc-main-a-f-1">
                  <h3>YOUR INFORMATION</h3>
                </div>
                <div className="hc-main-a-f-2">
                  <div>
                    <label>
                      FIRST NAME <span style={{ color: "red" }}>*</span>
                    </label>
                  </div>
                  <div className="hc-main-a-f-2-i-div">
                    <input
                      type="text"
                  ...
                  <div className="hc-main-f-m-l">
                    <h3>Mailing List</h3>
                  </div>
                  <div className="hc-main-f-checkbox-div">
                    <div className="hc-main-f-cb">
                      <input
                        type="checkbox"
                        checked={checked}
                    ...
                    <div>
                      <span className="hc-cb-span">
                        Keep me informed about upcoming classes *
                      </span>
                    </div>
                  </div>
                  <div className="hc-main-f-button">
                    <button
                      onClick={() => {
          ...
          {state == 2 && (
            <>
              <div className="hc-main-checkout">
                <div className="hc-main-co-title">
                  <h3>PAYMENT</h3>
                </div>
                <div className="hc-main-checkout-main">
                  <div className="hc-main-co-container">
                    <div className="hc-main-co-container-1">
                      <div className="hc-main-co-c-1">
                        <h3>Payment information</h3>
                      </div>
                      <div className="hc-main-co-c-2">
                        <div className="ap-paymentMethod">
                          ...
                          >
                            <div className="ap-pm-1-1">
                              ...
                              >
                                <div className="hc-creditCheckbox">
                                  <input
                                    type="checkbox"
                                    checked={creditCard}
                              ...
                              {creditCard && (
                                <div className="hc-creditCardsInputs">
                                  <div className="hc-creditCardsInput">
                                    <div>
                                      <label>
                                        FIRST NAME
                                  ...
                                  <div className="hc-cardDetails">
                                    <div className="hc-cardDetails-1">
                                      <label>
                                        CARD DETAILS
                                        <span style={{ color: "red" }}>*</span>
                                      </label>
                                    </div>
                                    <div className="hc-cardDetails-number">
                                      <div>
                                    ...
                                    <div className="hc-cardDetails-2">
                    ...
                    <div className="hc-main-co-container-2">
      ...
      {logForm && !registerForm && (
        <>
          <div className="hc-logForm-container">
            ...
            <div className="hc-main-button">
              <button className="hc-main-button" onClick={passwordReset}>
      ...
      {registerForm && !logForm && (
        <div className="hc-regForm-container">
          <div className="logForm-buttons">
            <button
              className="hc-main-button"
              onClick={() => {
          ...
          <div className="hc-regForm-txt-1">
            <h3>
          ...
          <div className="hc-regForm-cb">
            ...
            <div>
              <label className="hc-regForm-cb-label ">
                <p className="hc-regForm-cb-label-p">
                  I AGREE TO THE{" "}
                  <a
      ...
      {appointments && !registerForm && !logForm && (
        <div className="hc-appointments-container">
          <div className="logForm-buttons">
            <button
              className="hc-main-button"
              onClick={() => {
      ...
      {codes && !registerForm && !logForm && (
        <div className="hc-codesForm-container">
          <div className="logForm-buttons">
            <button
              className="hc-main-button"
              onClick={() => {
          ...
          <div className="upcoming-apps">
            <div>
              <p
                className="apps-1"
                style={
                  !isMobile ? { textAlign: "center", marginTop: "200px" } : {}
                }
              >
      ...
      {openTimeZone && (
        <div className="hc-timezone-container">
          {" "}
          <div className="logForm-buttons">
            <button
              className="hc-main-button"
